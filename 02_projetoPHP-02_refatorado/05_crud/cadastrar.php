 ...
 */
// --- Proteção: apenas usuário autenticados ---
...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if($form['nome'] === ''){
        $erro = 'O nome do projeto é obrigatório amigão.';
    }elseif($form['descricao'] === ''){
        $erro = 'A descrição é obrigatório big friend.';    
    }elseif($form['tecnologias'] === ''){
        $erro = 'Informe ao menos uma tecnologia, tá de sacanagem grand ami';
    }elseif($form['ano'] < 2000 || $form['ano'] > (int) date('Y') +1){
        $erro = 'Ano inválido Gran amigo.';
    }
...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            >
                <?php echo htmlspecialchars($form['descricao']); ?>
            </textarea>
        ...
        <p style="margin-top: 20px; text-align:center;">
            <a href="index.php" style="color: #9e0202;"><- Voltar à listagem</a>
        </p>
    </div>
