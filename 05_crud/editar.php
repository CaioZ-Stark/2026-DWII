 ...
 * Data         : 06/04/2026
 * Descrição    : Implementa o U do CRUD (Update 'Atualizar').
 *                Este arquivo tem três reponsabilidades:
...
<body>
    <div class="container">
        ...
        <form action="editar.php?id=<?php echo $id; ?>" method="post" class="formulario">
         ...
         <!-- value preenchido com dados atuais do banco (ou digitados, se houve erro) -->
            ...
            <div class="campo">
                ...
                <input type="text" name="tecnologias" class="input-texte" value="<?php echo htmlspecialchars($projeto['tecnologias']); ?>">
            </div>
